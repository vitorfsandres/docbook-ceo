...
> Registro de riscos estratégicos.
> Severidade sugerida: `baixa` | `média` | `alta` | `crítica`
> Origem = wikilink para a Nota de Reunião que levantou o risco.

| Risco | Domínio | Severidade | Origem | Status |
|-------|---------|------------|--------|--------|
| Plágio/cópia da ideia (mitigar com PI + NDAs/contratos) | Jurídico | alta | [[2025-09-07 - Análise jurídica e de negócios (Mauro, Simone)]] | aberto |
| Dependência de desenvolvedor / perda de controle do produto | Societário/Tecnologia | média | [[2025-09-07 - Análise jurídica e de negócios (Mauro, Simone)]] | aberto |
| Baixa adesão dos médicos (inércia cultural, exige UX fluida) | Produto | média | [[2025-09-11 - Apresentação Docbook e parceria (Vitor, Igor)]] | aberto |
| Custos de armazenamento de dados de pacientes | Financeiro/Tecnologia | baixa | [[2025-05-15 - Brainstorm pós-operatório (Eduardo, Vitor)]] | aberto |
| Gargalo financeiro / dependência da decisão de Peng (negativa exige Plano B) | Captação | alta | [[2025-09-23 - Captação — Plano A com Peng Lang (Vitor, Luiz Carlos)]] | aberto |
| Conflito de visão com a equipe do investidor (escopo/desenvolvimento) | Governança | média | [[2025-09-23 - Captação — Plano A com Peng Lang (Vitor, Luiz Carlos)]] | aberto |
...
| IA recriar tarefas já consolidadas a partir dos logs acumulados do WhatsApp (duplicidade de issues) — mitigar com controle estrito de timestamps + verificação ativa no repositório | Tecnologia/Operações | média | [[2026-07-23 - Automação de backlog com IA e exportação de prontuários (Vitor, Igor)]] | aberto |
