...
> Nota viva de sociedade e captação (sócios, PJ, investidores, cap table). ⚠️ Itens societários/financeiros **requerem aval de humano qualificado**.

## Sociedade
- **Eduardo + Vitor** (mai/2025) — origem [[G002 - Sociedade Eduardo e Vitor]]. ⚠️ Status atual não reconfirmado no acervo de set/2025 — CEO confirmar.
- **Vitor + Igor** (set/2025) — Igor como sócio, não prestador de serviço — origem [[G005 - Sociedade Vitor e Igor]].
- Relação entre as duas sociedades a esclarecer (ver [[Painel]]).

## Estrutura jurídica
- Abertura de PJ postergada para após validação do MVP; iniciar por contrato entre sócios — origem [[G007 - Postergar PJ; contrato entre sócios]].

## Captação / Investimento
- **Potencial investidor** (set/2025): pode aportar capital e disponibilizar equipes de TI e jurídica — a_reconferir — origem [[2025-09-26 - Arquitetura do MVP e potencial investidor (Vitor, Igor)]].
